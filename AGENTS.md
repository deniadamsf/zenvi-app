# AGENTS.md - Development & Auto-Deployment Rules for Zenvi
...
- Kalau sub-agent sebelumnya gagal/terputus di tengah jalan: **jangan** retry dengan agent besar yang sama. Turun dulu ke pencarian langsung (Grep/Grep/Read) sebelum mempertimbangkan spawn ulang.
