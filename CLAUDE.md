# CLAUDE.md - Development & Auto-Deployment Rules for Zenvi

> File ini identik dengan `AGENTS.md` dan `GEMINI.md` di root repo ini (dibaca Codex/Gemini/Antigravity). Project ini dikerjakan bergantian pakai beberapa AI coding tool, jadi kalau ada perubahan aturan di salah satu file, **wajib disalin ke ketiganya** supaya tidak drift.
